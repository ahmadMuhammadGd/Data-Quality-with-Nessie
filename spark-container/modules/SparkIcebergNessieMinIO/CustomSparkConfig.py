...
class IceBergNessieMinio:
    def __init__(self, 
                 nessie_url: str, minio_s3_bucket_path: str, 
                 minio_endpoint: str, minio_access_key: str, 
                 minio_secret_key: str, main_nessie_ref: str,
                 direct_read_write_minio:bool=False) -> None:
        ...
        self.direct_read_write_minio = direct_read_write_minio
        self.main_nessie_ref = main_nessie_ref
    def init(self) -> SparkConf:
        ...
        conf = SparkConf() \
            ...
            .set("spark.sql.catalog.nessie.ref"                         , self.main_nessie_ref) \
        ...
        if self.direct_read_write_minio:
            conf = conf .set("spark.hadoop.fs.s3a.path.style.access"                , True) \
                        .set("spark.hadoop.fs.s3a.impl"                             , "org.apache.hadoop.fs.s3a.S3AFileSystem") \
                        .set("spark.hadoop.fs.s3a.endpoint"                         , self.minio_endpoint)
