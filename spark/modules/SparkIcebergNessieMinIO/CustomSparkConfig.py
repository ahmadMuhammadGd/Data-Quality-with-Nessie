...
class IceBergNessieMinio:
    def __init__(self, nessie_url: str, MINIO_ICEBERG_S3_BUCKET_path: str, minio_endpoint: str, minio_access_key: str, minio_secret_key: str) -> None:
        self.nessie_url = nessie_url
        self.MINIO_ICEBERG_S3_BUCKET_path = MINIO_ICEBERG_S3_BUCKET_path
    ...
    def init(self) -> SparkConf:
        ...
        conf = SparkConf() \
            ...
            .set("spark.sql.catalog.nessie.warehouse"                   , self.MINIO_ICEBERG_S3_BUCKET_path) \
