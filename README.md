...
>![Airflow Dependency Graph | Data-Aware Scheduling](./md_assets/airflow/workflow/dep-graph.png)                              
...
## Error Handeling DAG
![ELT error handeling](./md_assets/airflow/dags/error-handling.png)
...
## Re-ingest DAG
![re-ingest](./md_assets/airflow/dags/re-ingest.png)


# Connections
![how dbt, soda, airflow connects to the data lakehouse](./md_assets/connections.png)
